# Generated by Django 3.1.4 on 2021-01-24 05:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number2', models.CharField(blank=True, max_length=12, null=True, unique=True)),
                ('additional_phone2', models.BooleanField(default=False)),
                ('phone_number3', models.CharField(blank=True, max_length=12, null=True, unique=True)),
                ('email', models.EmailField(blank=True, max_length=64, null=True, unique=True)),
                ('additional_email', models.BooleanField(default=False)),
                ('email2', models.EmailField(blank=True, max_length=64, null=True, unique=True)),
                ('additional_email2', models.BooleanField(default=False)),
                ('email3', models.EmailField(blank=True, max_length=64, null=True, unique=True)),
